...
const Home = (props) => {
    ...
    useEffect(() => {
      ...
      .from('.e-anim-1-text-2005', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2005')
      .from('.e-anim-2-2005', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2005', {duration:10, y:200, display:"none"})
      .addLabel('year-2005')
      .from('.edition-infos-container-2005', {duration:10, xPercent:100, display:"none"})
      .addLabel('infos-2005')
      .from('.editions-year-text-2005', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2005')
      .from('.editions-theme-text-2005', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2005, .hr-bottom-2005', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2005')
      .from('.editions-date-text-2005', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2005')
      .from('.editions-visitors-text-2005', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2006', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2006')
      .from('.e-anim-2-2006', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2006', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2006')
      .from('.editions-year-text-2006', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2006')
      .from('.editions-theme-text-2006', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2006, .hr-bottom-2006', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2006')
      .from('.editions-date-text-2006', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2006')
      .from('.editions-visitors-text-2006', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2007', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2007')
      .from('.e-anim-2-2007', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2007', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2007')
      .from('.editions-year-text-2007', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2007')
      .from('.editions-theme-text-2007', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2007, .hr-bottom-2007', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2007')
      .from('.editions-date-text-2007', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2007')
      .from('.editions-visitors-text-2007', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2008', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2008')
      .from('.e-anim-2-2008', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2008', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2008')
      .from('.editions-year-text-2008', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2008')
      .from('.editions-theme-text-2008', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2008, .hr-bottom-2008', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2008')
      .from('.editions-date-text-2008', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2008')
      .from('.editions-visitors-text-2008', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2009', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2009')
      .from('.e-anim-2-2009', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2009', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2009')
      .from('.editions-year-text-2009', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2009')
      .from('.editions-theme-text-2009', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2009, .hr-bottom-2009', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2009')
      .from('.editions-date-text-2009', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2009')
      .from('.editions-visitors-text-2009', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2010', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2010')
      .from('.e-anim-2-2010', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2010', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2010')
      .from('.editions-year-text-2010', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2010')
      .from('.editions-theme-text-2010', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2010, .hr-bottom-2010', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2010')
      .from('.editions-date-text-2010', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2010')
      .from('.editions-visitors-text-2010', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2011', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2011')
      .from('.e-anim-2-2011', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2011', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2011')
      .from('.editions-year-text-2011', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2011')
      .from('.editions-theme-text-2011', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2011, .hr-bottom-2011', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2011')
      .from('.editions-date-text-2011', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2011')
      .from('.editions-visitors-text-2011', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2012', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2012')
      .from('.e-anim-2-2012', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2012', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2012')
      .from('.editions-year-text-2012', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2012')
      .from('.editions-theme-text-2012', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2012, .hr-bottom-2012', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2012')
      .from('.editions-date-text-2012', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2012')
      .from('.editions-visitors-text-2012', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2013', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2013')
      .from('.e-anim-2-2013', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2013', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2013')
      .from('.editions-year-text-2013', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2013')
      .from('.editions-theme-text-2013', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2013, .hr-bottom-2013', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2013')
      .from('.editions-date-text-2013', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2013')
      .from('.editions-visitors-text-2013', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2014', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2014')
      .from('.e-anim-2-2014', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2014', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2014')
      .from('.editions-year-text-2014', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2014')
      .from('.editions-theme-text-2014', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2014, .hr-bottom-2014', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2014')
      .from('.editions-date-text-2014', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2014')
      .from('.editions-visitors-text-2014', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2015', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2015')
      .from('.e-anim-2-2015', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2015', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2015')
      .from('.editions-year-text-2015', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2015')
      .from('.editions-theme-text-2015', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2015, .hr-bottom-2015', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2015')
      .from('.editions-date-text-2015', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2015')
      .from('.editions-visitors-text-2015', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2016', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2016')
      .from('.e-anim-2-2016', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2016', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2016')
      .from('.editions-year-text-2016', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2016')
      .from('.editions-theme-text-2016', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2016, .hr-bottom-2016', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2016')
      .from('.editions-date-text-2016', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2016')
      .from('.editions-visitors-text-2016', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2017', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2017')
      .from('.e-anim-2-2017', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2017', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2017')
      .from('.editions-year-text-2017', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2017')
      .from('.editions-theme-text-2017', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2017, .hr-bottom-2017', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2017')
      .from('.editions-date-text-2017', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2017')
      .from('.editions-visitors-text-2017', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2018', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2018')
      .from('.e-anim-2-2018', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2018', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2018')
      .from('.editions-year-text-2018', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2018')
      .from('.editions-theme-text-2018', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2018, .hr-bottom-2018', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2018')
      .from('.editions-date-text-2018', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2018')
      .from('.editions-visitors-text-2018', {duration:10, transform:"scale(4)", opacity:0, y:400})
      ...
      .from('.e-anim-1-text-2019', {duration:10, y:-200, display:"none"})
      .addLabel('e-anim-2019')
      .from('.e-anim-2-2019', {duration:10, yPercent:-100, opacity:0, display:"none"})
      .from('.e-anim-2-text-2019', {duration:10, y:200, display:"none"})
      ...
      .addLabel('infos-2019')
      .from('.editions-year-text-2019', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .addLabel('year-text-2019')
      .from('.editions-theme-text-2019', {duration:10, opacity:0, transform:"scale(4)", y:400})
      .from('.hr-top-2019, .hr-bottom-2019', {duration:10, transform:"scaleX(0)", stagger:5})
      .addLabel('theme-text-2019')
      .from('.editions-date-text-2019', {duration:10, transform:"scale(4)", opacity:0, y:400})
      .addLabel('date-text-2019')
      .from('.editions-visitors-text-2019', {duration:10, transform:"scale(4)", opacity:0, y:400})
