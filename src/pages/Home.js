...
const Home = (props) => {
    ...
    useEffect(() => {
      tl.addLabel('start')
        ...
        .from('.img-3-container-2005', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2005', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2005', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2005', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2005', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2005")
        ...
        .from('.img-3-container-2006', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2006', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2006', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2006', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2006', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2006")
        ...
        .from('.img-3-container-2007', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2007', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2007', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2007', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2007', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2007")
        ...
        .from('.img-3-container-2008', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2008', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2008', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2008', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2008', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2008")
        ...
        .from('.img-3-container-2009', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2009', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2009', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2009', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2009', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2009")
        ...
        .from('.img-3-container-2010', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2010', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2010', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2010', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2010', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2010")
        ...
        .from('.img-3-container-2011', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2011', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2011', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2011', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2011', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2011")
        ...
        .from('.img-3-container-2012', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2012', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2012', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2012', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2012', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2012")
        ...
        .from('.img-3-container-2013', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2013', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2013', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2013', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2013', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2013")
        ...
        .from('.img-3-container-2014', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2014', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2014', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2014', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2014', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2014")
        ...
        .from('.img-3-container-2015', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2015', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2015', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2015', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2015', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2015")
        ...
        .from('.img-3-container-2016', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2016', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2016', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2016', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2016', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2016")
        ...
        .from('.img-3-container-2017', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2017', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2017', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2017', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2017', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2017")
        ...
        .from('.img-3-container-2018', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2018', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2018', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2018', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2018', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2018")
        ...
        .from('.img-3-container-2019', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-6-container-2019', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-4-container-2019', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-2-container-2019', {duration:.5, opacity:0, pointerEvents: "none"})
        .from('.img-5-container-2019', {duration:.5, opacity:0, pointerEvents: "none"})
        .addLabel("img-5-2019")
